  ...
  return (
    <section className="md:h-screen md:px-3 flex flex-col items-center md:flex-row md:justify-between transition-all ">
        <div className="left max-w-1/2 flex flex-col justify-evenly items-center md:items-start p-4 text-center md:text-left">
            ...
            <p className="text-lg my-2"> Inspiring Leaders Transform Organisations. Traditional, authoritarian leadership styles are no longer as effective, and organisations are increasingly recognizing the value of humble leadership qualities..</p>
            <button className="my-2 p-4 w-36 flex items-center justify-evenly bg-green-500 text-white capitalize rounded-full font-bold transition-all duration-300 hover:translate-x-2">Schedule a free discovery session<AiOutlineArrowRight /></button>
        </div>
